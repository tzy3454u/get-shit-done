...
<objective>
プロジェクトの完全なコンテキストを復元し、前回のセッションからシームレスに作業を再開する。

resume-project ワークフローにルーティングし、以下を処理する：
...
<process>
`@~/.claude/get-shit-done/workflows/resume-project.md` の **resume-project ワークフローに従うこと**。

ワークフローは以下のすべての再開ロジックを処理する：
